...
9. **פורמט:** התשובות מיועדות להעתקה לוואטסאפ. אל תשתמש לעולם במקפים ארוכים (—) ולא בחצים (←, →) - הם נשברים בוואטסאפ; במקומם השתמש בפסיק, נקודה מפרידה (·), או ניסוח רגיל. הדגשה ב-**כוכביות**. מותר להשתמש בטבלת markdown לרשימות (הממשק מרנדר אותה יפה וההעתקה ממירה אותה אוטומטית לשורות).
