...
const S: Record<string, React.CSSProperties> = {
  ...
  // flexWrap: במסך צר (מובייל) התוכן יורד שורה מתחת לניווט במקום להימחץ לידו
  body: { display: "flex", flexWrap: "wrap", gap: 12, alignItems: "flex-start", minHeight: 420 },
  nav: { width: 290, flexGrow: 1, maxWidth: "100%", background: "#fff", border: "1px solid #e3e6e0", borderRadius: 12,
  ...
  content: { flex: "1 1 340px", minWidth: 0, background: "#fff", border: "1px solid #e3e6e0", borderRadius: 12, padding: 16,
