...
/**
 * תחילית שמסמנת למודל הודעה שכתב נציג אנושי (ולא הבוט עצמו) בהיסטוריה.
 * בלעדיה המודל לא מבחין בין דבריו לדברי הצוות - וקרה בפועל (12.8) שנציג כתב
 * "אין מקום פנוי" והבוט "התנצל על הטעות" וסתר את הנציג. כלל 20 בפרומפט
 * מלמד את המודל לכבד את התיוג הזה כסמכות עליונה.
 */
