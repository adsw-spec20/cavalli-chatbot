...
9. **פורמט:** התשובות מיועדות לוואטסאפ. אל תשתמש לעולם במקפים ארוכים (—) ולא בחצים (←, →) - הם נשברים בוואטסאפ; במקומם השתמש בפסיק, נקודה מפרידה (·), או ניסוח רגיל. הדגשה ב-**כוכביות**.`;
