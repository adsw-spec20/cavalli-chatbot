...
const ESCALATE_TOOL: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      reason: {
        type: "string",
        description: "סיבת ההעברה בקצרה, תמיד בעברית (למשל: בקשת נציג, תלונה, אירוע פרטי)",
      },
      summary: {
        type: "string",
        description:
          "סיכום קצר של מה שהלקוח צריך או הבעיה שלו, כדי שהנציג האנושי יקבל הקשר מלא ולא יצטרך לשאול מהתחלה. חובה בעברית תמיד - גם כשהשיחה עצמה מתנהלת באנגלית או בכל שפה אחרת! זהו סיכום פנימי לצוות דובר עברית, הלקוח לא רואה אותו, וכלל 'המשך בשפת הלקוח' לא חל עליו.",
      },
      urgent: {
        type: "boolean",
        description:
